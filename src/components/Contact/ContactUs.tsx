...
export const ContactUs = () => {
  return (
    <div className="bg-white">
      <div
        className="py-16 bg-[#FFF7EB] relative lg:flex lg:justify-around lg:items-center
       grid sm:gap-0 lg:gap-10
      justify-center items-center px-4 lg:px-0"
      >
        ...
        <div className="text-primary-gray-50 text-center lg:text-left">
          ...
          <p className="text-base lg:text-xl text-[#000] font-medium ">
